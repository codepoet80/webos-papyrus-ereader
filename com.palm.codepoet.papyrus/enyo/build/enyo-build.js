...
for (var d = 0, e, f, g; e = a[d]; d++) g = this.calcControlFlex(e, b, c), f = e.domStyles, f[this.prefix + "-box-flex"] = g, f["flex-grow"] = g, g && (enyo.isMoz && b == "height" && this.align == "stretch" && (f.width = "100%"));
},
flow: function(a) {
var b = a.domStyles;
b[this.prefix + "-box-pack"] = a.pack || this.pack, b[this.prefix + "-box-align"] = a.align || this.align, b["justify-content"] = ({start:"flex-start",end:"flex-end",center:"center",justify:"space-between"})[a.pack||this.pack]||(a.pack||this.pack), b["align-items"] = ({start:"flex-start",end:"flex-end",center:"center",stretch:"stretch",baseline:"baseline"})[a.align||this.align]||(a.align||this.align), a.addClass(this.flexClass), this._flow(a.children);
}
}), enyo.kind({
