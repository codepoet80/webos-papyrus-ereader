/**
 * Translates an array of bytes from Windows-1258 to HTML Unicode escapes
 * @param {Object} bytes the array of bytes to convert.
 */
function translateWindows1258(bytes) {
	...
	for (var i = 0; i < bytes.length; i+=1) {
		...
		switch (bytes[i]) {
			...
			case 0xCC: code = 0x0300; break; //COMBINING GRAVE ACCENT
			...
			case 0xD2: code = 0x0309; break; //COMBINING HOOK ABOVE
			...
			case 0xD5: code = 0x01A0; break; //LATIN CAPITAL LETTER O WITH HORN
			...
			case 0xDD: code = 0x01AF; break; //LATIN CAPITAL LETTER U WITH HORN
			case 0xDE: code = 0x0303; break; //COMBINING TILDE
			...
			case 0xEC: code = 0x0301; break; //COMBINING ACUTE ACCENT
			...
			case 0xF2: code = 0x0323; break; //COMBINING DOT BELOW
			...
			case 0xF5: code = 0x01A1; break; //LATIN SMALL LETTER O WITH HORN
			...
			case 0xFD: code = 0x01B0; break; //LATIN SMALL LETTER U WITH HORN
			case 0xFE: code = 0x20AB; break; //DONG SIGN
